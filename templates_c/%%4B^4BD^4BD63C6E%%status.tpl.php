<?php /* Smarty version 2.6.26, created on 2012-10-11 01:16:53
...
<form action="status.php" method="post" name="sales_list" onSubmit="return data_check();">
	<div class="contentHeader">
			...
			<!--span class="saleCarInfo">會員編號：<?php echo $this->_tpl_vars['memberSN']; ?>
</span>

			<span class="saleNumber">訂單編號：<?php echo $this->_tpl_vars['saleSN']; ?>
</span-->
	  ...
	  <tr>
		...
		<table width="730" height="86" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
			  ...
			  <td width="397" valign="bottom"><div align="left"><span class="info">會員編號：<?php echo '<?'; ?>
 echo $LOG_PRVL.sprintf("%05d",$buyer); <?php echo '?>'; ?>
</span></div></td>
			...
			<table width="730" height="128" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
				...
				<td height="38" colspan="3"><select name="search_typ" style="font-size:9pt;width:110;height:20px;" onChange="search_type(this.options[this.selectedIndex].value);">
				  ...
				  <option value="1" <?php echo '<? if($_GET[MODE]=="SN"){ echo "selected"; } ?>'; ?>
>歷史訂單</option>
				  <option value="2" <?php echo '<? if($_GET[MODE]=="DATE_SEARCH" || $_POST[MODE]=="DATE_SEARCH"){ echo "selected"; } ?>'; ?>
>訂單日期</option>
				  <option value="5" <?php echo '<? if($_GET[MODE]=="MONTH_SEARCH" || $_POST[MODE]=="MONTH_SEARCH"){ echo "selected"; } ?>'; ?>
>訂單月份</option>
				  <option value="3" <?php echo ' <? if($_GET[MODE]=="FILES_SEARCH" || $_POST[MODE]=="FILES_SEARCH"){ echo "selected"; } ?>'; ?>
>案件名稱</option>
				  <option value="4" <?php echo '<? if($_GET[MODE]=="PRICE_SEARCH" || $_POST[MODE]=="PRICE_SEARCH"){ echo "selected"; } ?>'; ?>
>交易金額</option>
									</select>
				  <select name="detail" style="font-size:9pt;width:150;height:20px;" <?php echo '<? if($_GET[MODE]=="SN"){}else{ echo "disabled"; }?>'; ?>
 onChange="aq_select(this.options[this.selectedIndex].value);">
					<option value="0" selected><?php echo '<? if($_GET[MODE]=="SN"){ echo "--選擇訂單編號--"; }else if($_GET[MODE]=="DATE_SEARCH" || $_POST[MODE]=="DATE_SEARCH"){ echo "--於右側輸入下單日期--"; }else if($_GET[MODE]=="FILES_SEARCH" || $_POST[MODE]=="FILES_SEARCH"){ echo "於右側輸入檔案名稱"; }else if($_GET[MODE]=="PRICE_SEARCH" || $_POST[MODE]=="PRICE_SEARCH"){ echo "於右側輸入交易金額"; }else if($_GET[MODE]=="MONTH_SEARCH" || $_POST[MODE]=="MONTH_SEARCH"){ echo "--於右側輸入下單月份--"; }else{ echo "---------選擇參數---------"; }?>'; ?>
</option>
					<?php echo '<? if($_GET[MODE]=="SN"){ echo $SN_LIST_P; } ?>'; ?>

				  </select>                      
				  <input name="Caption" type="text"  style="font-size:9pt;width:120;height:18px;" onFocus="KEYWD()" size="8" <?php echo '<? if($_GET[MODE]=="DATE_SEARCH" || $_POST[MODE]=="DATE_SEARCH" || $_GET[MODE]=="FILES_SEARCH" || $_POST[MODE]=="FILES_SEARCH" || $_GET[MODE]=="PRICE_SEARCH" || $_POST[MODE]=="PRICE_SEARCH" || $_GET[MODE]=="MONTH_SEARCH" || $_POST[MODE]=="MONTH_SEARCH"){}else{ echo "disabled"; } ?>'; ?>
>                      
				...
				<td height="10" colspan="4"><div align="left">                      
				  <table width="100%" height="175" border="0" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width="226" height="35" class="topic">訂單資訊：<span class="info"><?php echo '<?'; ?>
 echo $List_mode; <?php echo '?>'; ?>
</span></td>
						...
						<tr>
						  <td height="55"><table width="100%" border="0" cellpadding="0" cellspacing="3">
							<tr valign="middle" bgcolor="#A56961" class="PS">
							  ...
							  <?php echo '<? if($DISPLAY_BUY_LIST==0){}else{ echo $BUY_LIST; }?>
							  <? 
								 if($CHECK_BUYED_R[0]==0){
								 }else{
									 if($trans_dis==1){}else{
								...
								<tr>
								  ...
								  <table width="100%" height="52"  border="0" cellpadding="0" cellspacing="3">
									  ...
									  <tr bgcolor="#E1E1C4">
										...
										<td width="538" height="30" bgcolor="#DCCBC5"><div align="center" class="info"><?php echo '<? if($DISPLAY_BUY_LIST==0){}else{ echo ($CHECK_BUYED_R[1][FINISH_PAY]+$CHECK_BUYED_R[1][TRANS_PRICE]); } ?>'; ?>
(已含稅)</div></td>
									  </tr>
								  </table></td>
								</tr>
						...
						<tr>
						  <td height="55"><table width="100%" border="0" cellpadding="0" cellspacing="3">                               
							...
							<tr valign="middle" bgcolor="#E9E9E9" class="contents">
							  ...
							  <td height="30"><div align="center"><span class="menu style26"><?php echo '<?'; ?>
 echo $pay_ta; <?php echo '?>'; ?>
</span></div></td>
							  <td height="30"><div align="center"><?php echo '<? if($DISPLAY_BUY_LIST==0){}else{ echo $PAY_PHOTO; } ?>'; ?>
</div></td>
							...
							<tr valign="middle" bgcolor="#E2E2E2" class="contents">
							  ...
							  <td height="30"><div align="center"><?php echo '<? if($DISPLAY_BUY_LIST==0){}else{ echo $FILES_PHOTO; } ?>'; ?>
</div></td>
							  <td height="30"><div align="left"></div>                                   <?php echo ' <? if($DISPLAY_BUY_LIST==1){ if($CHECK_BUYED_R[1][FILES_PS]!="0" && $CHECK_BUYED_R[1][FILES_PS]!=""){ echo "　".$CHECK_BUYED_R[1][FILES_PS]; } } ?>'; ?>
</td>
							</tr>
							<tr valign="middle" bgcolor="#DBDBDB" class="contents">
							  ...
							  <td height="30"><div align="center"><?php echo '<? if($DISPLAY_BUY_LIST==0){}else{ echo $PRINT_PHOTO; } ?>'; ?>
</div></td>
							  <td height="30"><div align="left"><?php echo '<? if($DISPLAY_BUY_LIST==1){ if($CHECK_BUYED_R[1][PRINT_PS]!="0" && $CHECK_BUYED_R[1][PRINT_PS]!=""){ echo "　".$CHECK_BUYED_R[1][PRINT_PS]; } } ?>'; ?>
</div></td>
							</tr>
							<tr valign="middle" bgcolor="#D4D4D4" class="contents">
							  ...
							  <td height="30"><div align="center"><?php echo '<? if($DISPLAY_BUY_LIST==0){}else{ echo $TRANS_PHOTO; } ?>'; ?>
</div></td>
							  <td height="30"><?php echo '<? if($DISPLAY_BUY_LIST==1){ if($CHECK_BUYED_R[1][TRANS_PS]!="0" && $CHECK_BUYED_R[1][TRANS_PS]!=""){ echo "　".$CHECK_BUYED_R[1][TRANS_PS]; } } ?>'; ?>
</td>
							</tr>
							<tr valign="middle" bgcolor="#CFCFCF" class="contents">
							  ...
							  <td height="30"><div align="center"><?php echo '<? if($DISPLAY_BUY_LIST==0){}else{ echo $CLOSE_PHOTO; } ?>'; ?>
</div></td>
							  <td height="30"><?php echo '<? if($DISPLAY_BUY_LIST==1){ if($CHECK_BUYED_R[1][CLOSE_PS]!="0" && $CHECK_BUYED_R[1][CLOSE_PS]!=""){ echo "　".$CHECK_BUYED_R[1][CLOSE_PS]; } if($CHECK_BUYED_R[1][CLOSE_DATE]!="" && $CHECK_BUYED_R[1][CLOSE_DATE]!=0){ echo "　".date("Y/m/d",$CHECK_BUYED_R[1][CLOSE_DATE])."結案"; }} ?>'; ?>
</td>
							</tr>
						  </table></td>
						</tr>
