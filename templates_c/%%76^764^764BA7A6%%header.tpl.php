<?php /* Smarty version 2.6.26, created on 2012-10-11 01:01:15
...
<div class="header">
    ...
    foreach ($_from as $this->_tpl_vars['attr'] => $this->_tpl_vars['list']):
?>						
						<li>							
							<a href="arri.php?MODE=<?php echo $this->_tpl_vars['list'][0]['SEQ_NBR']; ?>
"><?php echo $this->_tpl_vars['list'][1]; ?>
			...
			<li class="memberCenter">
				<ol class="subMenu">
					<?php if ($this->_tpl_vars['loginStatus'] == false): ?>
