<?php /* Smarty version 2.6.26, created on 2012-10-10 17:12:38
         compiled from ../templates/user_upload_fix.tpl */ ?>
...
<table width="600"  border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td>
			<form name="UPLOAD_FIX" action="user_fix_upload_fix_action.php?seq=<?php echo $this->_tpl_vars['seq']; ?>
&mbr=<?php echo $this->_tpl_vars['mbr']; ?>
" method="post" >
				<table width="600" class="colorBorder uploadedTable"  border="1" align="center" cellpadding="0" cellspacing="3">
					...
					<?php if (count ( $this->_tpl_vars['rowData'] ) > 0): ?>
					<?php $_from = $this->_tpl_vars['rowData']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['uploadedFiles'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['uploadedFiles']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['data']):
        $this->_foreach['uploadedFiles']['iteration']++;
?>									
						<?php if ($this->_tpl_vars['data']['FILE_NICK'] == '0'): ?>
							<?php $this->assign('FILE_NICK', ''); ?>
						<?php else: ?>
							<?php $this->assign('FILE_NICK', $this->_tpl_vars['data']['FILE_NICK']); ?>
						<?php endif; ?>
						<tr bgcolor="#F2F2F2" class="contents">
							<td height="35"><div align="center" class="style35"><?php echo ($this->_foreach['uploadedFiles']['iteration']-1)+1; ?>
</div></td>
							<td>
								<div align="center">
									<input name="files_nm<?php echo ($this->_foreach['uploadedFiles']['iteration']-1)+1; ?>
" class="fileNickName" type="text" id="files_nm<?php echo ($this->_foreach['uploadedFiles']['iteration']-1)+1; ?>
" style="font-size:9pt;width:200;height:16px;" value="<?php echo $this->_tpl_vars['FILE_NICK']; ?>
">
								</div>
							</td>
							<td>
								<div align="center"><?php echo $this->_tpl_vars['data']['FILE_NM']; ?>
</div>
							</td>
							<td>
								<div align="center">
									<input type="checkbox" name="del_sub[<?php echo ($this->_foreach['uploadedFiles']['iteration']-1)+1; ?>
]" value="<?php echo $this->_tpl_vars['data']['SEQ_NBR']; ?>
">
									<input type="hidden" name="SEQ_NBR[<?php echo ($this->_foreach['uploadedFiles']['iteration']-1)+1; ?>
]" value="<?php echo $this->_tpl_vars['data']['SEQ_NBR']; ?>
">
								</div>
							</td>
...
<script>
<?php if (count ( $this->_tpl_vars['rowData'] ) > 0): ?>
	var rowCount= <?php echo $this->_foreach['uploadedFiles']['total']; ?>
;
<?php else: ?>
	var rowCount= 0;
<?php endif; ?>
...
';
var mbr=<?php echo $this->_tpl_vars['mbr']; ?>
;
<?php echo '
...
<?php if ($this->_tpl_vars['Msg'] != ""): ?>	
	ErrMsgUpload('<?php echo $this->_tpl_vars['Msg']; ?>
');
<?php endif; ?>
</script>