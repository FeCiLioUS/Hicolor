<?php /* Smarty version 2.6.26, created on 2012-09-22 03:16:11
         compiled from ../templates/sales_car.tpl */ ?>
<style>
<?php echo '
...
<form action="del_buy_action.php?MODE=<?php echo $this->_tpl_vars['MODE']; ?>
&SUBKIND=<?php echo $this->_tpl_vars['SUBKIND']; ?>
" method="post" name="sales">	
...
<?php if ($this->_tpl_vars['hasBasket'] == true): ?>
...
<?php endif; ?>
	...
	<div class="saleDetail">
		<table class="saleDetailTable" cellpadding="0" cellspacing="3">
			...
			<tbody>
				<?php if ($this->_tpl_vars['hasBasket'] == true): ?>
					<?php $_from = $this->_tpl_vars['butyedInfo']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['buyKey'] => $this->_tpl_vars['buyItem']):
?>
						<tr>
							<td height="30"><?php echo $this->_tpl_vars['buyKey']+1; ?>
</td>
							<td height="30" title="<?php echo $this->_tpl_vars['buyItem']['kindName']; ?>
">
								<?php echo $this->_tpl_vars['buyItem']['kindName']; ?>

							</td>
							<td height="30" title="<?php echo $this->_tpl_vars['buyItem']['proSubKindName']; ?>
">
								<?php echo $this->_tpl_vars['buyItem']['proSubKindName']; ?>

							</td>
							<td height="30">
								<?php echo $this->_tpl_vars['buyItem']['face']; ?>
 面
							</td>
							<td height="30">
								<?php echo $this->_tpl_vars['buyItem']['finishX']; ?>
 X <?php echo $this->_tpl_vars['buyItem']['finishY']; ?>

							</td>
							<td height="30">
								<?php echo $this->_tpl_vars['buyItem']['count']; ?>

							</td>
							<td height="30">
								<?php echo $this->_tpl_vars['buyItem']['price']; ?>

							</td>
							<td height="30" class="uploadTd">
								<a href="javascript:<?php echo $this->_tpl_vars['buyItem']['uploadType']; ?>
(<?php echo $this->_tpl_vars['buyItem']['itemSN']; ?>
,<?php echo $this->_tpl_vars['buyKey']+1; ?>
);" class="<?php echo $this->_tpl_vars['buyItem']['upLoadClass']; ?>
" title="<?php echo $this->_tpl_vars['buyItem']['uploadMsg']; ?>
"></a>
							</td>
							<td height="30">
								<input type="checkbox" name="del_sub[<?php echo $this->_tpl_vars['buyKey']+1; ?>
]" value="<?php echo $this->_tpl_vars['buyItem']['itemSN']; ?>
">
							</td>
						</tr>
		...
		<table class="saleCountTable" cellpadding="0" cellspacing="3">
			<tr>
				...
				<td width="170" height="30" class="saleCountValue"><?php echo $this->_tpl_vars['subTotal']; ?>
</td>
				<td width="64" height="30" class="saleCountLabel">運　費</td>
				<td width="97" height="30" class="saleCountValue" id="trans_price"><?php echo $this->_tpl_vars['transTotal']; ?>
</td>
...
(已含稅金)
	...
	<div class="registFooter">
		...
		<div class="subCateSelection">
			...
			<a href="arri.php?MODE=<?php echo $this->_tpl_vars['MODE']; ?>
&SUBKIND=<?php echo $this->_tpl_vars['SUBKIND']; ?>
" class='continueBuy' title='繼續下單'>還要購物</a>
	...
	<input name="trans_p" type="hidden" value="<?php echo $this->_tpl_vars['transTotal']; ?>
">
</form>                
<SCRIPT>
var totalRows= <?php echo $this->_tpl_vars['saleTotal']; ?>
;
var saleSN= '<?php echo $this->_tpl_vars['saleSN']; ?>
';
var subTotal= <?php echo $this->_tpl_vars['subTotal']; ?>
;
var transTotal= <?php echo $this->_tpl_vars['transTotal']; ?>
;
var hasBaset= <?php echo $this->_tpl_vars['hasBasket']; ?>
;
<?php echo '
function trans(){
