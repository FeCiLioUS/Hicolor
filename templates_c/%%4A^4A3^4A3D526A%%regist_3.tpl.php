<?php /* Smarty version 2.6.26, created on 2012-10-10 21:35:09
         compiled from ../templates/regist_3.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', '../templates/regist_3.tpl', 151, false),)), $this); ?>
<style type="text/css">
<?php echo '
...
">
	...
	<div class="registFooter">
		...
		<div class="subCateSelection">
			...
			<input type="hidden" name="ACCOUNT" value="<?php echo $this->_tpl_vars['ACCOUNT']; ?>
">
			<input type="hidden" name="PWD" value="<?php echo $this->_tpl_vars['PWD']; ?>
">
		</div>
