<?
define("ERRO_HEAD_URL","NEWS_BglData_Upload.php");
define("OK_HEAD_URL","NEWS_BglData_Upload.php");
define("PRVL_SN", 0);
...
$upload_mode = "jpg,jpeg,bmp,gif,swf";//上傳格式限制;
